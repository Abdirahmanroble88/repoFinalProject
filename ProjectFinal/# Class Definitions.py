...
class DoctorManager:
    ...
    def read_doctors_file(self):                   #exception condition in case the file no Error or not found
        try:                                       #a For loop iterates over each line "_" and  removes any leading "_"
            with open(r"C:\Users\arobl\OneDrive\Documents\GitHub\MyRepo\EXAM\repoFinalProject\ProjectFinal\doctors.txt", "r") as file:
                for line in file:
    ...
    def write_list_of_doctors_to_file(self):
        with open(r"C:\Users\arobl\OneDrive\Documents\GitHub\MyRepo\EXAM\repoFinalProject\ProjectFinal\doctors.txt", "w") as file:
            for doctor in self.doctors:
...
class PatientManager:
    ...
    def read_patients_file(self):
        try:
            with open(r"C:\Users\arobl\OneDrive\Documents\GitHub\MyRepo\EXAM\repoFinalProject\ProjectFinal\patients.txt", "r") as file:
                for line in file:
    ...
    def write_list_of_patients_to_file(self):
        with open(r"C:\Users\arobl\OneDrive\Documents\GitHub\MyRepo\EXAM\repoFinalProject\ProjectFinal\patients.txt", "w") as file:
            for patient in self.patients:
